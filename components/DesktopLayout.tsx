 ...
 * 
 * Preserves the existing desktop experience:
 * - Sidebar on the left
 * - Main content area
...
export const DesktopLayout: React.FC<{ children: React.ReactNode; isAuthorized: boolean; onLogout: () => void }> = ({ children, isAuthorized, onLogout }) => {
